...
```{r}
write.csv(clinic, "/Users/ErikaLi/desktop/qbio/QBIO_490_erikali/analysis_data/brca_clinical_data.csv", row.names = FALSE)
...
```{r}
clinic <- read.csv("/Users/ErikaLi/desktop/qbio/QBIO_490_erikali/analysis_data/brca_clinical_data.csv")
...
```{r Exercise 4.1}
# create plot here
plot(clinic$age_at_diagnosis, clinic$death_days_to, main = "Age at Diagnosis to Death from Diagnosis", xlab = "Age at Diagnosis", ylab = "Days to Death from Diagnosis", col.axis = "blue")
...
```{r Exercise 4.2}
# create plot here
boxplot(clinic$age_at_diagnosis ~ clinic$gender, xlab = "", ylab = "", col.axis = "purple")
title(main = "Age at Diagnosis vs Gender ", xlab = "Gender", ylab = "Age at Diagnosis")
```
...
Around 0.30 (15 years is around 5000 days)
...
0.2, not statistically significant. It means that we cannot be confident that there is a relationship between age and breast cancer survival. 
